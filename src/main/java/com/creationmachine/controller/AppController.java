...
import com.creationmachine.model.Department;
...
public class AppController {
    ...
    public String saveEmployee(@Valid Employee employee, BindingResult result,
        ...
        model.addAttribute("success", "Employee " + employee.getFirstName() + " " + employee.getLastName() + " in " + employee.getBranch() + "(" + employee.getDepartment() + ")"  + " registered successfully");
